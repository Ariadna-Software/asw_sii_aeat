...
var apiFacturasRecibidasDetalle = {
    ...
    aceptar: function (event, done) {
        ...
        var data = {
            IDEnvioFacturasRecibidas: apiFacturasRecibidasDetalle.toNull(vm.IDEnvioFacturasRecibidas()),
            Origen: apiFacturasRecibidasDetalle.toNull(vm.Origen()),
            EnvioInmediato: apiFacturasRecibidasDetalle.toNull(vm.EnvioInmediato()),
            Enviada: apiFacturasRecibidasDetalle.toNull(vm.Enviada()),
            Resultado: apiFacturasRecibidasDetalle.toNull(vm.Resultado()),
            CSV: apiFacturasRecibidasDetalle.toNull(vm.CSV()),
            Mensaje: apiFacturasRecibidasDetalle.toNull(vm.Mensaje()),
            XML_Enviado: apiFacturasRecibidasDetalle.toNull(vm.XML_Enviado()),
            CAB_IDVersionSii: apiFacturasRecibidasDetalle.toNull(vm.CAB_IDVersionSii()),
            CAB_Titular_NombreRazon: apiFacturasRecibidasDetalle.toNull(vm.CAB_Titular_NombreRazon()),
            CAB_Titular_NIFRepresentante: apiFacturasRecibidasDetalle.toNull(vm.CAB_Titular_NIFRepresentante()),
            CAB_Titular_NIF: apiFacturasRecibidasDetalle.toNull(vm.CAB_Titular_NIF()),
            CAB_TipoComunicacion: apiFacturasRecibidasDetalle.toNull(vm.sTipoComunicacion()),
            REG_PI_Ejercicio: apiFacturasRecibidasDetalle.toNull(vm.REG_PI_Ejercicio()),
            REG_PI_Periodo: apiFacturasRecibidasDetalle.toNull(vm.sPeriodo()),
            REG_IDF_IDEF_NIF: apiFacturasRecibidasDetalle.toNull(vm.REG_IDF_IDEF_NIF()),
            REG_IDF_NumSerieFacturaEmisor: apiFacturasRecibidasDetalle.toNull(vm.REG_IDF_NumSerieFacturaEmisor()),
            REG_IDF_NumSerieFacturaEmisorResumenFin: apiFacturasRecibidasDetalle.toNull(vm.REG_IDF_NumSerieFacturaEmisorResumenFin()),
            REG_IDF_FechaExpedicionFacturaEmisor: apiFacturasRecibidasDetalle.toNull(vm.REG_IDF_FechaExpedicionFacturaEmisor()),
            REG_FR_TipoFactura: apiFacturasRecibidasDetalle.toNull(vm.sTipoRecibida()),
            REG_FR_TipoRectificativa: apiFacturasRecibidasDetalle.toNull(vm.sTipoRectificativa()),
            REG_FR_FR_IDR_NumSerieFacturaEmisor: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_FR_IDR_NumSerieFacturaEmisor()),
            REG_FR_IR_BaseRectificada: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_IR_BaseRectificada()),
            REG_FR_IR_CuotaRectificada: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_IR_CuotaRectificada()),
            REG_FR_IR_CuotaRecargoRectificado: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_IR_CuotaRecargoRectificado()),
            REG_FR_ClaveRegimenEspecialOTrascendencia: apiFacturasRecibidasDetalle.toNull(vm.sRegimen()),
            REG_FR_ClaveRegimenEspecialOTrascendenciaAdicional1: apiFacturasRecibidasDetalle.toNull(vm.sRegimen1()),
            REG_FR_ClaveRegimenEspecialOTrascendenciaAdicional2: apiFacturasRecibidasDetalle.toNull(vm.sRegimen2()),
            REG_FR_ImporteTotal: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_ImporteTotal()),
            REG_FR_NumRegistroAcuerdoFacturacion: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_NumRegistroAcuerdoFacturacion()),
            REG_FR_BaseImponibleACoste: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_BaseImponibleACoste()),
            REG_FR_DescripcionOperacion: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DescripcionOperacion()),
            REG_FR_CNT_NombreRazon: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_CNT_NombreRazon()),
            REG_FR_CNT_NIFRepresentante: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_CNT_NIFRepresentante()),
            REG_FR_CNT_NIF: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_CNT_NIF()),
            REG_FR_CNT_IDOtro_CodigoPais: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_CNT_IDOtro_CodigoPais()),
            REG_FR_CNT_IDOtro_IDType: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_CNT_IDOtro_IDType()),
            REG_FR_CNT_IDOtro_ID: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_CNT_IDOtro_ID()),

            REG_IDF_IDEF_IDOtro_CodigoPais: apiFacturasRecibidasDetalle.toNull(vm.REG_IDF_IDEF_IDOtro_CodigoPais()),
            REG_IDF_IDEF_IDOtro_IDType: apiFacturasRecibidasDetalle.toNull(vm.REG_IDF_IDEF_IDOtro_IDType()),
            REG_IDF_IDEF_IDOtro_ID: apiFacturasRecibidasDetalle.toNull(vm.REG_IDF_IDEF_IDOtro_ID()),

            REG_FR_DF_ISP_DI_DT1_TipoImpositivo: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT1_TipoImpositivo()),
            REG_FR_DF_ISP_DI_DT1_BaseImponible: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT1_BaseImponible()),
            REG_FR_DF_ISP_DI_DT1_CuotaSoportada: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT1_CuotaSoportada()),
            REG_FR_DF_ISP_DI_DT1_TipoREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT1_TipoREquivalencia()),
            REG_FR_DF_ISP_DI_DT1_CuotaREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT1_CuotaREquivalencia()),

            REG_FR_DF_ISP_DI_DT2_TipoImpositivo: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT2_TipoImpositivo()),
            REG_FR_DF_ISP_DI_DT2_BaseImponible: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT2_BaseImponible()),
            REG_FR_DF_ISP_DI_DT2_CuotaSoportada: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT2_CuotaSoportada()),
            REG_FR_DF_ISP_DI_DT2_TipoREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT2_TipoREquivalencia()),
            REG_FR_DF_ISP_DI_DT2_CuotaREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT2_CuotaREquivalencia()),

            REG_FR_DF_ISP_DI_DT3_TipoImpositivo: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT3_TipoImpositivo()),
            REG_FR_DF_ISP_DI_DT3_BaseImponible: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT3_BaseImponible()),
            REG_FR_DF_ISP_DI_DT3_CuotaSoportada: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT3_CuotaSoportada()),
            REG_FR_DF_ISP_DI_DT3_TipoREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT3_TipoREquivalencia()),
            REG_FR_DF_ISP_DI_DT3_CuotaREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT3_CuotaREquivalencia()),

            REG_FR_DF_ISP_DI_DT4_TipoImpositivo: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT4_TipoImpositivo()),
            REG_FR_DF_ISP_DI_DT4_BaseImponible: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT4_BaseImponible()),
            REG_FR_DF_ISP_DI_DT4_CuotaSoportada: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT4_CuotaSoportada()),
            REG_FR_DF_ISP_DI_DT4_TipoREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT4_TipoREquivalencia()),
            REG_FR_DF_ISP_DI_DT4_CuotaREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT4_CuotaREquivalencia()),

            REG_FR_DF_ISP_DI_DT5_TipoImpositivo: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT5_TipoImpositivo()),
            REG_FR_DF_ISP_DI_DT5_BaseImponible: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT5_BaseImponible()),
            REG_FR_DF_ISP_DI_DT5_CuotaSoportada: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT5_CuotaSoportada()),
            REG_FR_DF_ISP_DI_DT5_TipoREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT5_TipoREquivalencia()),
            REG_FR_DF_ISP_DI_DT5_CuotaREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT5_CuotaREquivalencia()),

            REG_FR_DF_ISP_DI_DT6_TipoImpositivo: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT6_TipoImpositivo()),

            REG_FR_DF_ISP_DI_DT6_BaseImponible: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT6_BaseImponible()),
            REG_FR_DF_ISP_DI_DT6_CuotaSoportada: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT6_CuotaSoportada()),
            REG_FR_DF_ISP_DI_DT6_TipoREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT6_TipoREquivalencia()),
            REG_FR_DF_ISP_DI_DT6_CuotaREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_ISP_DI_DT6_CuotaREquivalencia()),


            REG_FR_DF_DGI_DI_DT1_TipoImpositivo: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT1_TipoImpositivo()),
            REG_FR_DF_DGI_DI_DT1_BaseImponible: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT1_BaseImponible()),
            REG_FR_DF_DGI_DI_DT1_CuotaSoportada: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT1_CuotaSoportada()),
            REG_FR_DF_DGI_DI_DT1_TipoREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT1_TipoREquivalencia()),
            REG_FR_DF_DGI_DI_DT1_CuotaREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT1_CuotaREquivalencia()),
            REG_FR_DF_DGI_DI_DT1_PorcentCompensacionREAGYP: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT1_PorcentCompensacionREAGYP()),
            REG_FR_DF_DGI_DI_DT1_ImporteCompensacionREAGYP: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT1_ImporteCompensacionREAGYP()),

            REG_FR_DF_DGI_DI_DT2_TipoImpositivo: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT2_TipoImpositivo()),
            REG_FR_DF_DGI_DI_DT2_BaseImponible: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT2_BaseImponible()),
            REG_FR_DF_DGI_DI_DT2_CuotaSoportada: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT2_CuotaSoportada()),
            REG_FR_DF_DGI_DI_DT2_TipoREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT2_TipoREquivalencia()),
            REG_FR_DF_DGI_DI_DT2_CuotaREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT2_CuotaREquivalencia()),
            REG_FR_DF_DGI_DI_DT2_PorcentCompensacionREAGYP: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT2_PorcentCompensacionREAGYP()),
            REG_FR_DF_DGI_DI_DT2_ImporteCompensacionREAGYP: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT2_ImporteCompensacionREAGYP()),

            REG_FR_DF_DGI_DI_DT3_TipoImpositivo: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT3_TipoImpositivo()),
            REG_FR_DF_DGI_DI_DT3_BaseImponible: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT3_BaseImponible()),
            REG_FR_DF_DGI_DI_DT3_CuotaSoportada: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT3_CuotaSoportada()),
            REG_FR_DF_DGI_DI_DT3_TipoREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT3_TipoREquivalencia()),
            REG_FR_DF_DGI_DI_DT3_CuotaREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT3_CuotaREquivalencia()),
            REG_FR_DF_DGI_DI_DT3_PorcentCompensacionREAGYP: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT3_PorcentCompensacionREAGYP()),
            REG_FR_DF_DGI_DI_DT3_ImporteCompensacionREAGYP: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT3_ImporteCompensacionREAGYP()),

            REG_FR_DF_DGI_DI_DT4_TipoImpositivo: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT4_TipoImpositivo()),
            REG_FR_DF_DGI_DI_DT4_BaseImponible: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT4_BaseImponible()),
            REG_FR_DF_DGI_DI_DT4_CuotaSoportada: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT4_CuotaSoportada()),
            REG_FR_DF_DGI_DI_DT4_TipoREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT4_TipoREquivalencia()),
            REG_FR_DF_DGI_DI_DT4_CuotaREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT4_CuotaREquivalencia()),
            REG_FR_DF_DGI_DI_DT4_PorcentCompensacionREAGYP: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT4_PorcentCompensacionREAGYP()),
            REG_FR_DF_DGI_DI_DT4_ImporteCompensacionREAGYP: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT4_ImporteCompensacionREAGYP()),

            REG_FR_DF_DGI_DI_DT5_TipoImpositivo: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT5_TipoImpositivo()),
            REG_FR_DF_DGI_DI_DT5_BaseImponible: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT5_BaseImponible()),
            REG_FR_DF_DGI_DI_DT5_CuotaSoportada: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT5_CuotaSoportada()),
            REG_FR_DF_DGI_DI_DT5_TipoREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT5_TipoREquivalencia()),
            REG_FR_DF_DGI_DI_DT5_CuotaREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT5_CuotaREquivalencia()),
            REG_FR_DF_DGI_DI_DT5_PorcentCompensacionREAGYP: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT5_PorcentCompensacionREAGYP()),
            REG_FR_DF_DGI_DI_DT5_ImporteCompensacionREAGYP: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT5_ImporteCompensacionREAGYP()),

            REG_FR_DF_DGI_DI_DT6_TipoImpositivo: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT6_TipoImpositivo()),
            REG_FR_DF_DGI_DI_DT6_BaseImponible: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT6_BaseImponible()),
            REG_FR_DF_DGI_DI_DT6_CuotaSoportada: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT6_CuotaSoportada()),
            REG_FR_DF_DGI_DI_DT6_TipoREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT6_TipoREquivalencia()),
            REG_FR_DF_DGI_DI_DT6_CuotaREquivalencia: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT6_CuotaREquivalencia()),
            REG_FR_DF_DGI_DI_DT6_PorcentCompensacionREAGYP: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT6_PorcentCompensacionREAGYP()),
            REG_FR_DF_DGI_DI_DT6_ImporteCompensacionREAGYP: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_DF_DGI_DI_DT6_ImporteCompensacionREAGYP()),

            REG_FR_CuotaDeducible: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_CuotaDeducible()),
            REG_FR_FechaRegContable: apiFacturasRecibidasDetalle.toNull(vm.REG_FR_FechaRegContable())
        };
