...
var apiFacturasEmitidasDetalle = {
    ...
    aceptar: function (event, done) {
        ...
        var data = {
            IDEnvioFacturasEmitidas: apiFacturasEmitidasDetalle.toNull(vm.IDEnvioFacturasEmitidas()),
            Origen: apiFacturasEmitidasDetalle.toNull(vm.Origen()),
            EnvioInmediato: apiFacturasEmitidasDetalle.toNull(vm.EnvioInmediato()),
            Enviada: apiFacturasEmitidasDetalle.toNull(vm.Enviada()),
            Resultado: apiFacturasEmitidasDetalle.toNull(vm.Resultado()),
            CSV: apiFacturasEmitidasDetalle.toNull(vm.CSV()),
            Mensaje: apiFacturasEmitidasDetalle.toNull(vm.Mensaje()),
            XML_Enviado: apiFacturasEmitidasDetalle.toNull(vm.XML_Enviado()),
            CAB_IDVersionSii: apiFacturasEmitidasDetalle.toNull(vm.CAB_IDVersionSii()),
            CAB_Titular_NombreRazon: apiFacturasEmitidasDetalle.toNull(vm.CAB_Titular_NombreRazon()),
            CAB_Titular_NIFRepresentante: apiFacturasEmitidasDetalle.toNull(vm.CAB_Titular_NIFRepresentante()),
            CAB_Titular_NIF: apiFacturasEmitidasDetalle.toNull(vm.CAB_Titular_NIF()),
            CAB_TipoComunicacion: apiFacturasEmitidasDetalle.toNull(vm.sTipoComunicacion()),
            REG_PI_Ejercicio: apiFacturasEmitidasDetalle.toNull(vm.REG_PI_Ejercicio()),
            REG_PI_Periodo: apiFacturasEmitidasDetalle.toNull(vm.sPeriodo()),
            REG_IDF_IDEF_NIF: apiFacturasEmitidasDetalle.toNull(vm.REG_IDF_IDEF_NIF()),
            REG_IDF_NumSerieFacturaEmisor: apiFacturasEmitidasDetalle.toNull(vm.REG_IDF_NumSerieFacturaEmisor()),
            REG_IDF_NumSerieFacturaEmisorResumenFin: apiFacturasEmitidasDetalle.toNull(vm.REG_IDF_NumSerieFacturaEmisorResumenFin()),
            REG_FE_TipoFactura: apiFacturasEmitidasDetalle.toNull(vm.sTipoEmitida()),
            REG_FE_TipoRectificativa: apiFacturasEmitidasDetalle.toNull(vm.sTipoRectificativa()),
            REG_FE_FA_IDFA_NumSerieFacturaEmisor: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_FA_IDFA_NumSerieFacturaEmisor()),
            REG_FE_FR_IDR_NumSerieFacturaEmisor: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_FR_IDR_NumSerieFacturaEmisor()),
            REG_FE_IR_BaseRectificada: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_IR_BaseRectificada()),
            REG_FE_IR_CuotaRectificada: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_IR_CuotaRectificada()),
            REG_FE_IR_CuotaRecargoRectificado: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_IR_CuotaRecargoRectificado()),
            REG_FE_ClaveRegimenEspecialOTrascendencia: apiFacturasEmitidasDetalle.toNull(vm.sRegimen()),
            REG_FE_ClaveRegimenEspecialOTrascendenciaAdicional1: apiFacturasEmitidasDetalle.toNull(vm.sRegimen1()),
            REG_FE_ClaveRegimenEspecialOTrascendenciaAdicional2: apiFacturasEmitidasDetalle.toNull(vm.sRegimen2()),
            REG_FE_ImporteTotal: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_ImporteTotal()),
            REG_FE_BaseImponibleACoste: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_BaseImponibleACoste()),
            REG_FE_DescripcionOperacion: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_DescripcionOperacion()),
            REG_FE_DI_DT_SituacionInmueble: apiFacturasEmitidasDetalle.toNull(vm.sSituacionInmueble()),
            REG_FE_DI_DT_ReferenciaCatastral: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_DI_DT_ReferenciaCatastral()),
            REG_FE_ImporteTransmisionSujetoAIVA: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_ImporteTransmisionSujetoAIVA()),
            REG_FE_EmitidaPorTercero: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_EmitidaPorTercero()),
            REG_FE_VariosDestinatarios: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_VariosDestinatarios()),
            REG_FE_Cupon: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_Cupon()),
            REG_FE_CNT_NombreRazon: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_CNT_NombreRazon()),
            REG_FE_CNT_NIFRepresentante: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_CNT_NIFRepresentante()),
            REG_FE_CNT_NIF: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_CNT_NIF()),
            REG_FE_CNT_IDOtro_CodigoPais: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_CNT_IDOtro_CodigoPais()),
            REG_FE_CNT_IDOtro_IDType: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_CNT_IDOtro_IDType()),
            REG_FE_CNT_IDOtro_ID: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_CNT_IDOtro_ID()),
            REG_FE_TD_DF_SU_EX_CausaExencion: apiFacturasEmitidasDetalle.toNull(vm.sCausaExencion()),
            REG_FE_TD_DF_SU_EX_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_EX_BaseImponible()),
            REG_FE_TD_DF_SU_NEX_TipoNoExenta: apiFacturasEmitidasDetalle.toNull(vm.sTipoNoExenta()),

            REG_FE_TD_DF_SU_NEX_DI_DT1_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT1_TipoImpositivo()),
            REG_FE_TD_DF_SU_NEX_DI_DT1_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT1_BaseImponible()),
            REG_FE_TD_DF_SU_NEX_DI_DT1_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT1_CuotaRepercutida()),
            REG_FE_TD_DF_SU_NEX_DI_DT1_TipoREquivalencia: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT1_TipoREquivalencia()),
            REG_FE_TD_DF_SU_NEX_DI_DT1_CuotaREquivalencia: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT1_CuotaREquivalencia()),

            REG_FE_TD_DF_SU_NEX_DI_DT2_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT2_TipoImpositivo()),
            REG_FE_TD_DF_SU_NEX_DI_DT2_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT2_BaseImponible()),
            REG_FE_TD_DF_SU_NEX_DI_DT2_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT2_CuotaRepercutida()),
            REG_FE_TD_DF_SU_NEX_DI_DT2_TipoREquivalencia: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT2_TipoREquivalencia()),
            REG_FE_TD_DF_SU_NEX_DI_DT2_CuotaREquivalencia: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT2_CuotaREquivalencia()),

            REG_FE_TD_DF_SU_NEX_DI_DT3_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT3_TipoImpositivo()),
            REG_FE_TD_DF_SU_NEX_DI_DT3_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT3_BaseImponible()),
            REG_FE_TD_DF_SU_NEX_DI_DT3_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT3_CuotaRepercutida()),
            REG_FE_TD_DF_SU_NEX_DI_DT3_TipoREquivalencia: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT3_TipoREquivalencia()),
            REG_FE_TD_DF_SU_NEX_DI_DT3_CuotaREquivalencia: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT3_CuotaREquivalencia()),

            REG_FE_TD_DF_SU_NEX_DI_DT4_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT4_TipoImpositivo()),
            REG_FE_TD_DF_SU_NEX_DI_DT4_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT4_BaseImponible()),
            REG_FE_TD_DF_SU_NEX_DI_DT4_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT4_CuotaRepercutida()),
            REG_FE_TD_DF_SU_NEX_DI_DT4_TipoREquivalencia: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT4_TipoREquivalencia()),
            REG_FE_TD_DF_SU_NEX_DI_DT4_CuotaREquivalencia: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT4_CuotaREquivalencia()),

            REG_FE_TD_DF_SU_NEX_DI_DT5_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT5_TipoImpositivo()),
            REG_FE_TD_DF_SU_NEX_DI_DT5_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT5_BaseImponible()),
            REG_FE_TD_DF_SU_NEX_DI_DT5_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT5_CuotaRepercutida()),
            REG_FE_TD_DF_SU_NEX_DI_DT5_TipoREquivalencia: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT5_TipoREquivalencia()),
            REG_FE_TD_DF_SU_NEX_DI_DT5_CuotaREquivalencia: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT5_CuotaREquivalencia()),

            REG_FE_TD_DF_SU_NEX_DI_DT6_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT6_TipoImpositivo()),
            REG_FE_TD_DF_SU_NEX_DI_DT6_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT6_BaseImponible()),
            REG_FE_TD_DF_SU_NEX_DI_DT6_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT6_CuotaRepercutida()),
            REG_FE_TD_DF_SU_NEX_DI_DT6_TipoREquivalencia: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT6_TipoREquivalencia()),
            REG_FE_TD_DF_SU_NEX_DI_DT6_CuotaREquivalencia: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_SU_NEX_DI_DT6_CuotaREquivalencia()),

            REG_FE_TD_DF_NSU_ImportePorArticulos7_14_Otros: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_NSU_ImportePorArticulos7_14_Otros()),
            REG_FE_TD_DF_NSU_ImporteTAIReglasLocalizacion: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DF_NSU_ImporteTAIReglasLocalizacion()),
            REG_FE_TD_DTS_SU_EX_CausaExencion: apiFacturasEmitidasDetalle.toNull(vm.sCausaExencion1()),
            REG_FE_TD_DTS_SU_EX_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_EX_BaseImponible()),
            REG_FE_TD_DTS_SU_NEX_TipoNoExenta: apiFacturasEmitidasDetalle.toNull(vm.sTipoNoExenta1()),

            REG_FE_TD_DTS_SU_NEX_DI_DT1_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT1_TipoImpositivo()),
            REG_FE_TD_DTS_SU_NEX_DI_DT1_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT1_BaseImponible()),
            REG_FE_TD_DTS_SU_NEX_DI_DT1_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT1_CuotaRepercutida()),

            REG_FE_TD_DTS_SU_NEX_DI_DT2_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT2_TipoImpositivo()),
            REG_FE_TD_DTS_SU_NEX_DI_DT2_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT2_BaseImponible()),
            REG_FE_TD_DTS_SU_NEX_DI_DT2_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT2_CuotaRepercutida()),

            REG_FE_TD_DTS_SU_NEX_DI_DT3_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT3_TipoImpositivo()),
            REG_FE_TD_DTS_SU_NEX_DI_DT3_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT3_BaseImponible()),
            REG_FE_TD_DTS_SU_NEX_DI_DT3_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT3_CuotaRepercutida()),

            REG_FE_TD_DTS_SU_NEX_DI_DT4_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT4_TipoImpositivo()),
            REG_FE_TD_DTS_SU_NEX_DI_DT4_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT4_BaseImponible()),
            REG_FE_TD_DTS_SU_NEX_DI_DT4_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT4_CuotaRepercutida()),

            REG_FE_TD_DTS_SU_NEX_DI_DT5_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT5_TipoImpositivo()),
            REG_FE_TD_DTS_SU_NEX_DI_DT5_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT5_BaseImponible()),
            REG_FE_TD_DTS_SU_NEX_DI_DT5_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT5_CuotaRepercutida()),

            REG_FE_TD_DTS_SU_NEX_DI_DT6_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT6_TipoImpositivo()),
            REG_FE_TD_DTS_SU_NEX_DI_DT6_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT6_BaseImponible()),
            REG_FE_TD_DTS_SU_NEX_DI_DT6_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_SU_NEX_DI_DT6_CuotaRepercutida()),

            REG_FE_TD_DTS_NSU_ImportePorArticulos7_14_Otros: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_NSU_ImportePorArticulos7_14_Otros()),
            REG_FE_TD_DTS_NSU_ImporteTAIReglasLocalizacion: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTS_NSU_ImporteTAIReglasLocalizacion()),
            REG_FE_TD_DTE_SU_EX_CausaExencion: apiFacturasEmitidasDetalle.toNull(vm.sCausaExencion2()),
            REG_FE_TD_DTE_SU_EX_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_EX_BaseImponible()),
            REG_FE_TD_DTE_SU_NEX_TipoNoExenta: apiFacturasEmitidasDetalle.toNull(vm.sTipoNoExenta2()),

            REG_FE_TD_DTE_SU_NEX_DI_DT1_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT1_TipoImpositivo()),
            REG_FE_TD_DTE_SU_NEX_DI_DT1_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT1_BaseImponible()),
            REG_FE_TD_DTE_SU_NEX_DI_DT1_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT1_CuotaRepercutida()),

            REG_FE_TD_DTE_SU_NEX_DI_DT2_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT2_TipoImpositivo()),
            REG_FE_TD_DTE_SU_NEX_DI_DT2_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT2_BaseImponible()),
            REG_FE_TD_DTE_SU_NEX_DI_DT2_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT2_CuotaRepercutida()),

            REG_FE_TD_DTE_SU_NEX_DI_DT3_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT3_TipoImpositivo()),
            REG_FE_TD_DTE_SU_NEX_DI_DT3_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT3_BaseImponible()),
            REG_FE_TD_DTE_SU_NEX_DI_DT3_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT3_CuotaRepercutida()),

            REG_FE_TD_DTE_SU_NEX_DI_DT4_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT4_TipoImpositivo()),
            REG_FE_TD_DTE_SU_NEX_DI_DT4_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT4_BaseImponible()),
            REG_FE_TD_DTE_SU_NEX_DI_DT4_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT4_CuotaRepercutida()),

            REG_FE_TD_DTE_SU_NEX_DI_DT5_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT5_TipoImpositivo()),
            REG_FE_TD_DTE_SU_NEX_DI_DT5_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT5_BaseImponible()),
            REG_FE_TD_DTE_SU_NEX_DI_DT5_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT5_CuotaRepercutida()),

            REG_FE_TD_DTE_SU_NEX_DI_DT6_TipoImpositivo: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT6_TipoImpositivo()),
            REG_FE_TD_DTE_SU_NEX_DI_DT6_BaseImponible: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT6_BaseImponible()),
            REG_FE_TD_DTE_SU_NEX_DI_DT6_CuotaRepercutida: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_SU_NEX_DI_DT6_CuotaRepercutida()),

            REG_FE_TD_DTE_NSU_ImportePorArticulos7_14_Otros: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_NSU_ImportePorArticulos7_14_Otros()),
            REG_FE_TD_DTE_NSU_ImporteTAIReglasLocalizacion: apiFacturasEmitidasDetalle.toNull(vm.REG_FE_TD_DTE_NSU_ImporteTAIReglasLocalizacion())
        };
