...
var loginDbAPI = {
    login: function (login, password, done) {
        comun.getConnectionCallback(function (err, con) {
            ...
            var sql = "SELECT u.*, gu.nombre as grupo , t.nifTitular FROM usuarios as u";
            sql += " LEFT JOIN grupos_usuarios as gu ON gu.grupoUsuarioId = u.grupoUsuarioId";
            sql += " LEFT JOIN titulares as t ON t.titularId = u.titularId";
