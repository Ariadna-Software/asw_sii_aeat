...
var crearRegSiiRecibida = function (r) {
    ...
    if (r.PAIS == "ES") {
        ...
        reg.REG_IDF_IDEF_IDOtro_IDType = "02";
    ...
    if (r.PAIS == "ES") {
        ...
        reg.REG_FR_CNT_IDOtro_IDType = "02";
...
var desgloseIVARecibida = function (r, reg) {
    if (r.INVERSIONSUJETOPASIVO == 1) {
        ...
        var pos = 0;
        for (var i = 1; i <= 6; i++) {
            var str = "REG_FR_DF_ISP_DI_DT" + i + "_TipoImpositivo";
            if (!reg[str]) {
                pos = 1;
                break;
            }
        ...
        var pos = 0;
        for (var i = 1; i <= 6; i++) {
            var str = "REG_FR_DF_DGI_DI_DT" + i + "_TipoImpositivo";
            if (!reg[str]) {
                pos = 1;
                break;
            }
