    ...
    async.eachSeries(data, function (r, callback) {
        ...
        if (r.GDESVATNUM != antGDESVATNUM || moment(r.INVOICEDATE).format("YYYYMMDD") != antINVOICEDATE || r.INVOICEID != antINVOICEID || antVATNUM != r.VATNUM) {
            ...
            if (primerCaso) {
                ...
                if (antTipo == 1) {
                    console.log("1I:", antINVOICEID, "B1", b1, "B2", b2); 
                    if (basetotal === baseparcial) {
                        console.log("GRABA", "B1", b1, "B2", b2); 
                        ...
                        console.log("Descuadre Lineas ID", antINVOICEID, "BT", basetotal, "B", baseparcial);
                        callback();
                    }
