...
var faturasRecibidasDbToJsAPI = {
  ...
  recibidasDbToJs: function (dbObject) {
    ...
    if (dbObject.REG_IDF_IDEF_IDOtro_ID) {
      ...
      jsObject.RegistroLRFacturasRecibidas.IDFactura.IDEmisorFactura.NIF = null;
    }
    ...
    for (var i = 1; i <= 6; i++) {
      ...
      if (dbObject[reg] != null) {
        ...
        var detalleIva = {
          ...
          CuotaSoportada: dbObject["REG_FR_DF_DGI_DI_DT" + i + "_CuotaSoportada"]
        }
    ...
    if (dbObject.REG_FR_CNT_IDOtro_ID) {
      ...
      jsObject.RegistroLRFacturasRecibidas.FacturaRecibida.Contraparte.NIF = null;
    }
    //
