...
var faturasRecibidasDbToJsAPI = {
  ...
  recibidasDbToJs: function (dbObject) {
    ...
    if (dbObject.REG_FR_IR_BaseRectificada) {
    ...
    for (var i = 1; i <= 6; i++) {
      ...
      if (dbObject[reg] != null) {
        ...
        var detalleIva = {
          ...
          CuotaRepercutida: dbObject["REG_FR_DF_ISP_DI_DT" + i + "_CuotaRepercutida"]
        }
        ...
        if (dbObject["REG_FR_DF_ISP_DI_DT" + i + "_CuotaREquivalencia"])
          detalleIva.TipoRecargoEquivalencia = dbObject["REG_FR_DF_ISP_DI_DT" + i + "_CuotaREquivalencia"];
    ...
    for (var i = 1; i <= 6; i++) {
      ...
      if (dbObject[reg] != null) {
        // hay un tipo para declarar
        var detalleIva = {
          TipoImpositivo: dbObject["REG_FR_DF_DGI_DI_DT" + i + "_TipoImpositivo"],
          BaseImponible: dbObject["REG_FR_DF_DGI_DI_DT" + i + "_BaseImponible"],
          CuotaRepercutida: dbObject["REG_FR_DF_DGI_DI_DT" + i + "_CuotaRepercutida"]
        }
    ...
    jsObject.RegistroLRFacturasRecibidas.FacturaRecibida.CuotaDeducible = dbObject.CuotaDeducible;
    return jsObject;
  }
}
