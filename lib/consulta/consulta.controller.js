...
router.get('/emitidas/:nif/:ejercicio/:periodo', function (req, res) {
    ...
    fnConsultarUnPeriodo(nif, ejercicio, periodo, function(err, regs){
...
router.get('/emitidas/:nif/:ejercicio', function (req, res) {
    var ejercicio = req.params.ejercicio
    var nif = req.params.nif
    async.eachSeries(["01","02","03","04","05","06","07","08","09","10","11","12"])
});

var fnConsultarUnPeriodo = function(nif, ejercicio, periodo, done){
    var filtro = {
        Cabecera: {
            IDVersionSii: "1.0",
            Titular: {
